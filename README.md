...
## Background
* problem 1:
* The CE marking process is a legal requirement for accessing the EU market, but it is often slow, complex, and highly dependent on manual work.
...
* problem 2:
* •	Managing large technical files across departments
•	Ensuring up to date compliance documentation
 These challenges are common across industries such as machinery, industrial equipment, electronics, and automation. Because CE marking is mandatory, delays or errors can prevent market entry, increase costs, or create safety risks.
Personal motivation:
